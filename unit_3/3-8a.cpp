...
//   - Recursively call selection sort on the first
//     'capacity - 1' entries of the array
...
void selection_sort( double array[], std::size_t capacity ) {
    if ( capacity <= 1 ) {
        ...
        // Not necessary in the actual implementation,
        // but just testing to ensure all is correct
